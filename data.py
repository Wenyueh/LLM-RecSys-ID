...
if __name__ == "__main__":
    ...
    parser.add_argument("--no_tokenization", action="store_true")
    ...
    # dataset = sequential_item_dataset(
    #    args, users, train_sequence, task_subgroup_1, remap_fct
    # )

    # dataset = sequential_yesno_dataset(
    #    args, users, all_items, train_sequence, task_subgroup_2, remap_fct
    # )
    # dataset = direct_yesno_dataset(
    #    args, users, all_items, test_sequence, task_subgroup_3, remap_fct
    # )
